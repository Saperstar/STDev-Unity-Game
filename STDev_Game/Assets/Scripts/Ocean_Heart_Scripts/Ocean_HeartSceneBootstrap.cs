...
public class Ocean_HeartSceneBootstrap : MonoBehaviour
{
    ...
    private void CreateUI()
    {
        ...
        Button mapExitButton = CreateButton("Ocean_HeartMapExitButton", canvasObject.transform, "맵으로 나가기");
        SetRect(mapExitButton.GetComponent<RectTransform>(), new Vector2(0.02f, 0.92f), new Vector2(0.18f, 0.985f));
